# DemoBlaze Website – Software Testing Project

# Project Overview

This repository presents a complete software testing project executed on the Demoblaze web application.
The project demonstrates both manual and automation testing practices to validate core functionalities of the system.
...
├── target/                             # Compiled files and build outputs
├── test-output/                        # TestNG reports and execution results
...
https://github.com/revathy3/DemoBlaze-Website-Software-Testing-Project.git
